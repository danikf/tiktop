...
| 9 | ✅ **Port-based grouping** | `a` cykluje přes None→BySrc→ByDst→ByPort; ByPort seskupuje toky dle dst portu, remote sloupec zobrazuje service name (https/ssh/rdp…) nebo číslo portu dle resolve modu |
